...
enum SalesData {
    ...
    static let last30Days = [
        (day: date(year: 2022, month: 5, day: 8), sales: 10),
        (day: date(year: 2022, month: 5, day: 9), sales: 9),
        (day: date(year: 2022, month: 5, day: 10), sales: 10),
        (day: date(year: 2022, month: 5, day: 11), sales: 11),
        (day: date(year: 2022, month: 5, day: 12), sales: 10),
        (day: date(year: 2022, month: 5, day: 13), sales: 10),
        (day: date(year: 2022, month: 5, day: 14), sales: 16),
        (day: date(year: 2022, month: 5, day: 15), sales: 12),
        (day: date(year: 2022, month: 5, day: 16), sales: 8),
        (day: date(year: 2022, month: 5, day: 17), sales: 11),
        (day: date(year: 2022, month: 5, day: 18), sales: 13),
        (day: date(year: 2022, month: 5, day: 19), sales: 11),
        (day: date(year: 2022, month: 5, day: 20), sales: 10),
        (day: date(year: 2022, month: 5, day: 21), sales: 18),
        (day: date(year: 2022, month: 5, day: 22), sales: 17),
        (day: date(year: 2022, month: 5, day: 23), sales: 11),
        (day: date(year: 2022, month: 5, day: 24), sales: 10),
        (day: date(year: 2022, month: 5, day: 25), sales: 14),
        (day: date(year: 2022, month: 5, day: 26), sales: 12),
        (day: date(year: 2022, month: 5, day: 27), sales: 14),
        (day: date(year: 2022, month: 5, day: 28), sales: 10),
        (day: date(year: 2022, month: 5, day: 29), sales: 10),
        (day: date(year: 2022, month: 5, day: 30), sales: 13),
        (day: date(year: 2022, month: 5, day: 31), sales: 13),
        (day: date(year: 2022, month: 6, day: 1), sales: 10),
        (day: date(year: 2022, month: 6, day: 2), sales: 12),
        (day: date(year: 2022, month: 6, day: 3), sales: 14),
        (day: date(year: 2022, month: 6, day: 4), sales: 14),
        (day: date(year: 2022, month: 6, day: 5), sales: 10),
        (day: date(year: 2022, month: 6, day: 6), sales: 10)
    ].map { Sale(day: $0.day, hoursOfSleep: $0.sales) }

    /// Total sales for the last 30 days.
    static var last30DaysTotal: Int {
        last30Days.map { $0.hoursOfSleep }.reduce(0, +)
    }
